...
<div class="container-fluid bg-primary py-5 text-white">
    <div class="container">
        <div class="row align-items-center mainDiv">
            ...
            <div class="col-lg-3 col-md-3 col-12 d-flex justify-content-end ctaBtn">
                <div class="interestedinctabtn">
                    <a class="d-flex align-items-center  btn btn-white text-primary btn-icon icon-arrow" href="#">Get in Touch
