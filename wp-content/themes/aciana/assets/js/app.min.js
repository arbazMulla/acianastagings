    ...
    (e = (function () {
      ...
      (e.prototype.buildOut = function () {
        ...
        (e.$slides = e.$slider
          ...
          (e.$slideTrack =
            0 === e.slideCount
              ? t('<div aria-label="Home Solution Items" class="slick-track"/>').appendTo(e.$slider)
              : e.$slides.wrapAll('<div aria-label="Home Solution Items" class="slick-track"/>').parent()),
          (e.$list = e.$slideTrack
