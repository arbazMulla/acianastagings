...
get_header(); ?>
	...
	<?php while ( have_posts() ) : the_post(); $p_id = $post->ID;?>
		<main id="main" class="site-main" role="main">
			<div class="solution-single-main">
				<div class="container-fluid">
					<div class="col-max-10 col-center">
						<div class="page-banner">
								...
								<div class="animate-it"><?php the_post_thumbnail('full');?></div>
					...
					<?php if( have_rows('page_content') ):?>
						<?php  while ( have_rows('page_content') ) : the_row();?>
							<?php if( get_row_layout() == 'main_content' ):?>
								<div class="col-max-10 col-center">
									<div class="page-main-content animate-it">
				...
				?>
					<div class="other-solution-items">
						<div class="section-head animate-it">
							<h2 class="section-title animate-it">Other solutions that might interest you…</h2>
						</div>
