...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if ((premium = "")) {
        ...
        document
            .querySelector(".premium .planCols:nth-child(2) .pricingplanheadercontent .basicPlancontent .labelPlaceholder")
            .appendChild(premiumbasicLabel);
    }
    ...
    if ((premium = "")) {
        ...
        document
            .querySelector(".premium .planCols:nth-child(4) .pricingplanheadercontent .basicPlancontent .labelPlaceholder")
            .appendChild(premiumstandardLabel);
    }
});
...
//     $("#menu-header_menu li.dropdown a").each(function () {
...
// const activePage = window.location.pathname;
// console.log(activePage);
// const navLinks = document.querySelectorAll("#menu-header_menu li.dropdown a");
// navLinks.forEach((link) => {
//     if (link.href.includes(`${activePage}`)) {
//         link.classList.add("qwerty");
//         console.log("Done");
//     }
// });
