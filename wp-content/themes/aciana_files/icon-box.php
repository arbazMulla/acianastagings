...
<div class="<?= $uid; ?> <?= esc_attr($className); ?>">
    <div class="container">
        <div class="row">
            ...
            ?>
                <div class="icon_box_content d-flex align-items-center gap-4 my-2 p-3 <?php echo esc_attr('bg-' . $bg); ?>">
            ...
            ?>
                <div class="icon_box_content d-flex align-items-center gap-4 my-2 p-3">
                    <img class="img-fluid img-responsive" src="<?php echo $image; ?>" alt="">
                    <h6 class="fw-600 mb-0 <?php echo esc_attr('text-' . $color) ?>"><?php echo $content; ?></h6>
                </div>
            <?php endif; ?>
